...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		int number;
		 ...
		 if(number < 0) {
			 JOptionPane.showMessageDialog(null, "Invalid input, number must be positive");
		 } else {
		...
		JOptionPane.showMessageDialog(null, "Find the hidden button to win");
		//13. initialize the hiddenButton variable to a random number less than the int created in step 3
		hiddenButton = rand.nextInt(0, number);
